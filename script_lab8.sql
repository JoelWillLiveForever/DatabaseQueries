...
SELECT
    ...
    SUM(Продажи.Количество_проданного_товара) AS Суммарный_объем_продаж,
    Товары.Наименование_единицы_измерения,
    Продавцы.Фамилия,
    Продавцы.Имя,
    Продавцы.Отчество,
...
FROM 
    Продавцы
JOIN 
    Товары_Продавцы ON Продавцы.ID_продавца = Товары_Продавцы.ID_продавца
JOIN 
    Продажи ON Товары_Продавцы.ID_товара_продавца = Продажи.ID_товара_продавца
JOIN
    Товары ON Товары_Продавцы.ID_товара = Товары.ID_товара
GROUP BY 
    Товары.Наименование_товара,
    Товары.Наименование_единицы_измерения,
